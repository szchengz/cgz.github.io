...
/**
 * Created by cgz on 2019-05-29 23:01
 * 描述：
 */
public class LuozhuangTanZao {


    public String[][] DayZhuMemo;


    public LuozhuangTanZao() {
     ...
     */
    public String paipan(String man) throws ParseException {
    ...
    private String paipan(Calendar cal) throws ParseException {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.print( test.paipan("1977-5-2 22"));
